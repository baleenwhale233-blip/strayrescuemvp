...
- `getCaseRecordDetail` returns record details for expenses, progress updates, budget adjustments, and support records.
- `updateExpenseRecord` lets the case owner edit an expense while appending the old and new snapshots to `expense_records.revisionHistory`.
