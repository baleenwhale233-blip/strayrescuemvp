...
目标：把页面改版范围讲清楚，让设计工具或后来接手的人知道先画什么、暂时别画什么。

设计原则：

- 先改能跑通最小闭环的页面
- 能改现有页面就不先重画
- 先做“发现 + 判断 + 登记 + 处理”，再补档案维护者每天会用的生产页
...
这不是功能很多的公益平台。它现在只做一个小而清楚的透明查档工具。
