...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "不要把预估总预算直接说成当前缺口。当前缺口要看总预算和已确认支持之间还差多少。",
