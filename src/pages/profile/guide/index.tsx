...
const SECTIONS: GuideSection[] = [
  {
    ...
    paragraphs: [
      "尽量让正在救助这只动物的人自己建档。",
      "这个档案不是一次性的转发文案。后面还要补支出、更新病情、处理支持登记，也要回答别人问起的情况。谁能长期跟进，谁就更适合做档案维护者。",
  ...
  },
  {
    ...
    paragraphs: [
      "公开页和首页是两件事。公开页负责让别人能查到；首页只放已经补到一定程度、适合先看的档案。",
  ...
  },
  {
    ...
    paragraphs: [
      "可以帮，但最好别把责任揽到自己账号里。",
      "更有用的帮忙，是把第一版资料整理好：拍清票据，帮忙顺一下描述，提醒对方更新，再把公开页或案例 ID 转出去。这样帮完以后，档案还能由真正负责的人继续维护。",
    ],
  },
];
  ...
  return (
    <PageShell className="profile-guide-page">
      ...
      <View className="profile-guide-page__hero">
        ...
        <Text className="profile-guide-page__title">先把档案讲清楚</Text>
        <Text className="profile-guide-page__lead">
          这页只说几件实用的事：谁适合建档、账本能做什么、看到一份档案时该看哪里。
        </Text>
      </View>
