...
export function buildSupportSheetCopy(input: {
  ...
  if (hasWechatId && hasPaymentQr) {
    return {
      contactHint: "复制微信号或保存二维码后，可在微信里联系档案维护者",
      directHint: "长按图片保存到相册，打开微信扫一扫查看联系信息",
      contactTip: "联系上档案维护者后，可继续沟通这份档案的情况。",
  ...
  if (hasWechatId) {
    return {
      contactHint: "复制微信号后，可在微信里联系档案维护者",
      directHint: "当前未提供二维码，可先通过微信联系档案维护者确认方式。",
      contactTip: "联系上档案维护者后，可继续沟通这份档案的情况。",
  ...
  if (hasPaymentQr) {
    return {
      ...
      directHint: "长按图片保存到相册，打开微信扫一扫查看联系信息",
      contactTip: "若需了解更多细节，可先扫码联系档案维护者。",
      directTip: "如已完成线下转账或其他方式记录，可回到页面登记支持。",
    };
  }
